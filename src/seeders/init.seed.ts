...
type VistaData = {
 ...
 const vistasData = async (): Promise<VistaData[]> => {
  ...
  agregarVistasPorRol("admin_principal", [
    ...
    { nombreVista: "Ver Participaciones Conflicto", vistaSuperior: "Repertorio" },
    { nombreVista: "Otorgar Prórroga Conflicto", vistaSuperior: "Repertorio" },
  ...
  agregarVistasPorRol("productor_principal", [
    ...
    { nombreVista: "Buscar Repertorio", vistaSuperior: "Repertorio" },
    { nombreVista: "Conflictos", vistaSuperior: "Repertorio" },
    { nombreVista: "Confirmar Porcentaje Conflicto", vistaSuperior: "Repertorio" },
    { nombreVista: "Enviar Documentación Conflicto", vistaSuperior: "Repertorio" },
    { nombreVista: "Ver Titularidad", vistaSuperior: "Repertorio" },
