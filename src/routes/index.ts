...
import repertorioRoutes from './fonogramas';
import conflictoRoutes from './conflictos';
import cuentaCorrienteRoutes from './cashflow';
import archivoRoutes from './archivos';
import reporteRoutes from './reportes';
import tramiteRoutes from './territorialidad';
import sesionRoutes from './auditoria';
